          ...
          <div class="col-lg-4 col-sm-6 mt-sm-3 mb-sm-3  mt-2 mb-2">
            <div class="card solutions-list-box">
              <div class="card-body">
                ...
                <p>
                  Want to increase the visibility of your store? Are you looking
                  to shift your retail outlet to a mobi...
                </p>
                <div>
                  <a
                    class="more-btn"
          ...
          <div class="col-lg-4 col-sm-6 mt-sm-3 mb-sm-3  mt-2 mb-2">
            <div class="card solutions-list-box">
              <div class="card-body">
                ...
                <p>
                  Are you into food delivery? Do you want to create an on-demand
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mt-3 text-md-right">
                    <a title="Contact Us" class="btn btn-danger" href="https://www.expertappdevs.com/contact-us">Contact Us</a>
                </div>
            </div>
        </div>
    </section>
